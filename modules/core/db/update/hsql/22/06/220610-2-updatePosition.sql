...
-- alter table KDP_POSITION add column COMPANY_ID_ID varchar(36) ^
-- update KDP_POSITION set COMPANY_ID_ID = <default_value> ;
-- alter table KDP_POSITION alter column COMPANY_ID_ID set not null ;
alter table KDP_POSITION add column COMPANY_ID_ID varchar(36) not null ;
