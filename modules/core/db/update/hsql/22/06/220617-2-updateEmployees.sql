alter table KDP_EMPLOYEES alter column DEPARTMENT_ID rename to DEPARTMENT_ID__U25946 ^
alter table KDP_EMPLOYEES alter column DEPARTMENT_ID__U25946 set null ;
